...
.shortselect{  
        ...
        <section class="aui-flexView">
            ...
            <section class="aui-scrollView mh-form-page">
                <div class="mh-form-hero">
                    <div class="mh-form-hero-text">
                        <h1>上传你的心动档案</h1>
                        <p>真实头像 + 基本信息，帮助月老更快撮合；可随时更新与下架。</p>
                    </div>
                    <div class="mh-avatar-upload am-form-file">
                        <input type="file" onchange="fileUpload(this, 'tx')">
                        <div class="mh-avatar-preview">
                            <img id="touxiang" width="150" height="150" src="../public/index/img/touxiang/moren.png" alt="avatar">
                            <span>点击更换头像</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mh-form-card">
                    ...
                    <div class="layui-form layui-form-pane mh-form-radio">
                    ...
                    <div class="mh-textarea-wrap">
                        <label>个人介绍</label>
                        <textarea placeholder="请输入您的个人介绍" class="layui-textarea" id="jieshao"></textarea>
                    </div>
                </div>

                <a id="toudi" class="mh-pay-card">
                    <div class="mh-pay-amount">
                        <small>￥</small><?php echo $toudi_money;?>
                    </div>
                    <div class="mh-pay-meta">
                        <p>立即加入盲盒</p>
                        <span>被抽取后信息将自动隐藏</span>
                    </div>
                    <div class="mh-pay-arrow">→</div>
                </a>
                <p class="mh-form-hint">提交即视为同意平台使用头像及简介进行展示。</p>
                <div class="mh-form-bottom-space"></div>
            </section>
